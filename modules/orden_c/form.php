    ...
    <div class="container-fluid">
        <div class="fade-in">
            ...
            <div class="card">
                ...
                <form action="modules/orden_c/proses.php?act=insert" method="POST" class="form-horizontal"
                    id="formPresupuesto">
                    <div class="card-body">
                        <?php
                        // Generar código único
                        $query_id = mysqli_query($mysqli, "SELECT MAX(id_orden_comp) as id FROM orden_compra")
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <button type="button" class="btn btn-info" data-coreui-toggle="modal"
                                    ...
                                    <i class="fa fa-plus"></i> Buscar Presupuesto
                                </button>
                            </div>
                        </div>
                        ...
                        <br>
                        <div class="form-group">
                            <label class="col-md-2 col-form-label">Cantidad Aprobada</label>
                            <div class="col-md-2">
                ...
                <td>${cantidad}</td>
                <td>
                <button type="button" class="btn btn-danger btn-smonclick="eliminarFila(this)">
                Eliminar
                </button>
                </td>
                </tr>
                `;
                            ...
                            document.getElementById('formPresupuesto').addEventListener('submit', function (event) {
                                ...
                                filas.forEach(fila => {
                                    ...
                                    productos.push({
                                        codigoProducto: columnas[0].textContent.trim(), // Columna codigo Producto
                                        Producto: columnas[1].textContent.trim(), // Columna Producto
                                        cantidad: parseFloat(columnas[2].textContent.trim()), // Columna Cantidad
                                    });
                                });
                    ...
                    <div class="card-footer">
                        ...
                        <a href="?module=orden_c" class="btn btn-secondary">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    function load(page) {
        ...
        $("#loader").fadeIn('slow');
        $.ajax({
            url: './ajax/productos_pedido_orden.php',
            data: parametros,
    ...
    function agregar(id) {
        ...
        $.ajax({
            type: "POST",
            url: "./ajax/agregar_pedido_orden.php",
        ...
        $.ajax({
            type: "POST",
            url: "modules/orden_c/ajax/obtener_productos_pedido.php",
